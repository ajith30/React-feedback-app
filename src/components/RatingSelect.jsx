...
function RatingSelect({select}) {
  ...
  const handleChange = (e) => {
    setSelected(+e.target.value);  // or parseInt(e.target.value)
    select(+e.target.value);
    //Note: Remember if the props value is some function/named function while calling it in the actual component
    // always call by props name not by the original function name inorder to invoke it.
  }
